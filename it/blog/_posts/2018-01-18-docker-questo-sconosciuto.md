...
`docker-compose up`, il quale estrapola le informazioni di configurazione (mapping di porte, volumi, tag), per default, da un file chiamato *docker-compose.yml* ed esegue il container con tutte le relative opzioni.
